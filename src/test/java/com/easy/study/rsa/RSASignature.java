...
public class RSASignature {
    ...
    private static final Logger logger = Logger.getLogger(RSASignature.class);
    ...
    public static String decrypt(String content, String key) throws Exception {
        ...
        InputStream ins = new ByteArrayInputStream(Base64.decodeBase64(content.getBytes("UTF-8")));
    ...
    public static PrivateKey getPrivateKey(String key) throws Exception {
        ...
        keyBytes = Base64.decodeBase64(key.getBytes("UTF-8"));
    ...
    public static String signIt(String content, String privateKey) {
        ...
        try {
            ...
            logger.error("Ali Exception@sign", e);
        }
    ...
    public static String sign(String bwOrderId, String content, String privateKey) {
        ...
        try {
            ...
            logger.error("[" + bwOrderId + "] Ali Exception@sign", e);
        }
    ...
    public static boolean doCheck(String content, String sign, String publicKey) {
        try {
            ...
            logger.error(" Ali Exception@doCheck", e);
        }
